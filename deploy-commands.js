...
(async () => {
  try {
    ...
    console.log('  /kyriz shop              — Browse the shop catalog');
    console.log('  /kyriz buy <item>        — Buy an item');
    console.log('  /kyriz use <item>        — Use a consumable or equip a cosmetic');
    console.log('  /kyriz inventory         — View your items, cosmetics & boosts');
    console.log('  /kyriz profile [user]    — View your (or someone\'s) profile card');
